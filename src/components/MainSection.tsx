...
const MainSection = () => {
  return (
    <main className="lg:ml-[13.25rem] w-full lg:max-w-[40rem] h-full lg:border-r flex-col">
      <div className="border-b py-2 flex items-center sticky top-0 bg-white z-50 ">
        <div className="flex items-center justify-between w-full px-6  py-1">
          ...
          <div className="rounded-xl border border-gray-300 px-2 py-2 space-x-5 flex items-center justify-between text-xs cursor-pointer">
            <Link href={"/"} className="px-2 font-[550] active:text-mitralist ">
              NEWEST
            </Link>
      ...
      <div className="hidden sm:flex bg-gray-50 px-4 py-4 w-full z-10 flex-col border-b border-gray-300 space-y-2 relative items-stretch">
      ...
      <div className="flex flex-col">
        {Array.from({ length: 5 }).map((_, i) => (
          <div key={i} className="flex px-4 md:px-6 py-4 border-b  space-x-2">
            <div className="flex">
            ...
            <div className="flex flex-col space-y-2">
              ...
              <div className="max-w-[95%] lg:max-w-full">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. A
                consequuntur veritatis eos perferendis porro id sunt voluptatem
                iure. Ullam dignissimos assumenda ex sint qui id, tempora et
                eveniet.
              </div>
              <div className="bg-slate-300 aspect-square sm:h-85  lg:h-96 max-h-[600px] rounded-2xl  object-cover"></div>
              <div className="flex items-center justify-between md:w-full sm:max-w-[95%] py-2">
                <div className="flex items-center justify-start space-x-4 md:space-x-16 w-full">
